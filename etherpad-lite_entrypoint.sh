...
ln -sf $ETHERPAD_DATADIR/settings.json $ETHERPAD_INSTALLDIR/settings.json

chown -RL etherpad-lite:etherpad-lite $ETHERPAD_INSTALLDIR $ETHERPAD_DATADIR
exec start-stop-daemon --start --chuid etherpad-lite:etherpad-lite --exec $ETHERPAD_INSTALLDIR/bin/run.sh
